...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'podcasts_list'    => new sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'podcast')),
    ...
    $this->setValidators(array(
      ...
      'podcasts_list'    => new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'podcast', 'required' => false)),
  ...
  public function addPodcastsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('podcast_usuario.podcast_id', $values)
    ;
  }
