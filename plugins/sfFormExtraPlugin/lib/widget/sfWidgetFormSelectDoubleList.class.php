...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="/alumno/entrega3/web/images/2'.$unassociate_image.'" alt="unassociate" />');
    $this->addOption('associate', '<img src="/alumno/entrega3/web/images/2'.$associate_image.'" alt="associate" />');
